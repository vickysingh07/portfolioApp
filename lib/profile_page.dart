...
class VickyDot extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Row(
      children: <Widget>[
...
//            borderRadius: BorderRadius.circular(40),
  ...
  final profileData = Column(
    ...
    children: <Widget>[
      ...
      Text(
        "I am a beginner in app development field."
        "I got 9.23 sgpa in first semester and 8.7sgpa in second semester."
        "My skills are C++, data structure and problem solving."
        "My goal is to be a successful app developer.",
        softWrap: true,
        textScaleFactor: 1.5,
